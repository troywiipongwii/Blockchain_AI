'''Loan Request is a special kind of transaction.  Should this go in the transaction file or should they be two separate things
should we have as a default both the opportunity to send/receive on GUI along with loanRequest'''

# maybe credit_scoring should go under verification instead of here.
# maybe breakup loanrequest and loan approval since requested and actual may have different values
...
class LoanRequest(Printable):
    ...
    def credit_rating(self):
        ...
        if creditRating < FAIRCREDIT:
            # this needs to be rejected and shows up as a rejected loan in the block.  
            pass