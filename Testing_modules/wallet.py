...
class Wallet:
    ...
    def verify_transaction(transaction):
        ...
        j = SHA256.new((str(transaction.sender) + str(transaction.length) + str(transaction.amount) + str(transaction.apr)).encode('utf8'))
        return verifier.verify(h, binascii.unhexlify(transaction.signature)) or verifier.verify(j, binascii.unhexlify(transaction.signature))